...
for people_dir in os.listdir("docs/people"):
    ...
    if os.path.exists(os.path.join("docs/people", people_dir, "projects.md")):
        projects_html = markdown_to_html(
            os.path.join("docs/people", people_dir, "projects.md")
        )
    else:
        projects_html = None
    if os.path.exists(os.path.join("docs/people", people_dir, "publications.md")):
        publications_html = markdown_to_html(
            os.path.join("docs/people", people_dir, "publications.md")
        )
    else:
